 ...
 * 
 * 1) Menu button @ bottom-left, should open up into an "Add Private Space" and
 * "Delete PrivateSpace" 2) Bottom bar with icons representing all existing
 * Private Spaces 3) Main button @ bottom-right, should take you back to this
 * window
 */
