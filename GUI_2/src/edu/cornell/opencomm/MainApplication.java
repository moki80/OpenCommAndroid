...
public class MainApplication extends Activity {
	...
	/**
	 * if you created a new PrivateSpace, then createNewPrivateSpace and tell
	 * the network (I'm assumming we don't need to be notified if someone else
	 * created a privateSpace we are not aware of)
	 */
	public void sendCreateNewPrivateSpace(int PrivateSpaceID, Person user) {
		// TODO
	...
	/** Notify the network that you added a new person to the privateSpace */
	public void sendAddUserToPrivateSpace(int PrivateSpaceID, Person user){
		// TODO
	}
	...
	/** If you deleted someone from a privateSpace, notify everyone */
	 ...
	 */
	public void updatePrivateSpace(int PrivateSpaceID){
